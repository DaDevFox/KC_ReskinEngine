...
namespace ReskinEngine.API
{
    ...
    {
        [Model(description = "The main model of the gate, excluding the porticulus", type = ModelAttribute.Type.Modular)]
        public GameObject gate;
        [Model(description = "The part of the gate that moves up and down to show opening/closing", type = ModelAttribute.Type.Modular)]
